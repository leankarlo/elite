var Category = function () {
    ...
    var handleCategoryList = function() {
        ...
        /* Send the data */
        $.ajax({
            url: "../../../../../canvas/projects/category/level/getall",
            async: false,
            type: "get",
    ...
    return {
        ...
        initCategory: function(){
            //category select
            var url = '../../../../../canvas/projects/category/getall'
            $.ajax({
                url: url,
                async: false,
                type: "get",
...
$(document).ready(function() {
    ...
    window.DeleteCategoryLevel = function(id){
        /* Send the data */
        $.ajax({
            url: "../../../../../canvas/projects/category/level/delete&id="+id,
            async: false,
            type: "get",
    ...
    window.saveElement = function(id, parentID, position){
        ...
        /* Send the data */
        $.ajax({
            url: "../../../../../canvas/projects/category/level/update",
            async: false,
            type: "post",
            data: data_params,
            success: function (data) {
    ...
    window.addCategoryList = function(){
        ...
        /* Send the data */
        $.ajax({
            url: "../../../../../canvas/projects/category/level/add&id="+categoryid,
            async: false,
            type: "get",
            success: function (data) {
                toastr.success(data.result, data.message)
    ...
    window.CreateCategory = function(){
        ...
        var url = '../../../../../canvas/projects/category/create_new&name='+name
        $.ajax({
            url: url,
            async: false,
            type: "get",
